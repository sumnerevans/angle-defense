...
public class CostManager {
    public static final int GroundPriceLevel0 = 30;
    public static final int GroundPriceLevel1 = 50;
    public static final int GroundPriceLevel2 = 120;
    public static final int GroundPriceLevel3 = 300;
    public static final int AirPriceLevel0 = 25;
